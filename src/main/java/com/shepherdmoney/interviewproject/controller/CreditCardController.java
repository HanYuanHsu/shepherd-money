...
public class CreditCardController {
    ...
    /**
     * Given a list of transactions (payload), update credit cards' balance history.
     ...
     * @param payload
     * @return A ResponseEntity with an appropriate HTTP status code and response body.
     *            - 200 ok: if update is done and successful.
     *            - 400 Bad Request: if any card number specified in a transaction is not associated with a card
     */
